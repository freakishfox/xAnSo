/******************************************************************************* 
 *  @file      dyn_section.cpp 2017\5\11 20:37:00 $
 *  @author    df
 *  @brief     
 ******************************************************************************/
...
bool dyn_section::from_string(std::string str_content)
{
    ...
    //copy content
    memcpy((char *)&dyn_section_, str_content.c_str(), sizeof(Elf32_Dyn));
    return true;
}
...
std::string dyn_section::print()
{
    ...
    styled_section += ("Tag: " + util::itoa(dyn_section_.d_tag) + "\n");
    styled_section += ("Value: " + util::itoa(dyn_section_.d_un.d_val) + "\n");

    return styled_section;
}

std::string dyn_section::tag_2_string(int tag)
{
    switch (tag)
    {
    case DT_NULL:
